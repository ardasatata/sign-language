...
def predict_keypoint(input=r'F:\Dataset\Sign Language\Demo CSL\Temp\11_05_2021_01_43_23.mp4', output=r"F:\Dataset\Sign Language\Demo CSL\Temp\11_05_2021_01_43_23.npy"):
    with torch.no_grad():
        ...
        checkpoint = torch.load(
            r'F:\Dataset\Sign Language\AUTSL\SAM-SLR\data_process\hrnet_w48_coco_wholebody_384x288-6e061c6a_20200922.pth')
        ...
        while cap.isOpened():
            ...
            if not success:
                ...
                break
            img = img[0 + CROP_TOP:720, 0 + CROP_X:1280 - CROP_X]
